...
B01 = sp.N(B01.subs({theta: math.radians(-71.57), alpha: math.radians(-90), a: 0, S: 490}))
...
B02 = transformation()
display(B02)
B02 = sp.N(B02.subs({theta: math.radians(0), alpha: math.radians((-39.36)), a: 0, S: 150}))
...
B03 = transformation()
display(B03)
B03 = sp.N(B03.subs({theta: math.radians(0), alpha: math.radians((97.68)), a: 0, S: 700}))
...
B04 = transformation()
display(B04)
B04 = sp.N(B04.subs({theta: math.radians(0), alpha: math.radians((+45)), a: 0, S: 600}))
